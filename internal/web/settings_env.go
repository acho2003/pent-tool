...
func allEnvSettingDefinitions() []envSettingDefinition {
	...
	return []envSettingDefinition{
		...
		{Key: "XALGORIX_SCAN_CPU_LOAD", Label: "Scan CPU load", Category: "Resources", Description: "Expected CPU load per scan.", DefaultValue: "1.0", InputType: "number", RequiresRestart: true},
		{Key: "XALGORIX_SCAN_MEMORY_BUDGET_MB", Label: "Scan memory budget MB", Category: "Resources", Description: "Memory budget per scan.", DefaultValue: "2048", InputType: "number", RequiresRestart: true},
		{Key: "XALGORIX_SCAN_OVERHEAD_MB", Label: "Scan overhead MB", Category: "Resources", Description: "Reserved memory overhead per scan.", DefaultValue: "384", InputType: "number", RequiresRestart: true},
		{Key: "XALGORIX_HEAVY_TOOL_MEM_LIMIT_MB", Label: "Heavy tool memory limit MB", Category: "Resources", Description: "Memory limit for heavy terminal tools.", InputType: "number", RequiresRestart: true},
	}
}
